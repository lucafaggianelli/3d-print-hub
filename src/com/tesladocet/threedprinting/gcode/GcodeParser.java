...
public class GcodeParser {
    ...
    public float getSmallArcSegmentLength() {
        return smallArcSegmentLength;
    }

    public void setSmallArcSegmentLength(float smallArcSegmentLength) {
        this.smallArcSegmentLength = smallArcSegmentLength;
    }

    public float getSmallArcThreshold() {
        return smallArcThreshold;
    }

    public void setSmallArcThreshold(float smallArcThreshold) {
    ...
    public List<PointSegment> expandArc() {
        ...
        Point3f start     = startSegment.point();
        Point3f end       = lastSegment.point();
        Point3f center    = lastSegment.center();
        ...
        PointSegment temp;
        // skip first element.
        Iterator<Point3f> psi = expandedPoints.listIterator(1);
        while (psi.hasNext()) {
    ...
    private PointSegment addLinearPointSegment(Point3f nextPoint, boolean fastTraverse) {
    ...
    private PointSegment addArcPointSegment(Point3f nextPoint, boolean clockwise, List<String> args) {
        PointSegment ps = new PointSegment(nextPoint, commandNumber++);
        ...
        float radius = GcodePreprocessorUtils.parseCoord(args, 'R');
    ...
    private PointSegment handleGCode(String code, List<String> args) {
        PointSegment ps = null;
        Point3f nextPoint = GcodePreprocessorUtils.updatePointWithCommand(
    ...
    public List<String> convertArcsToLines(String command) {
        ...
        Point3f start = new Point3f(this.currentPoint);
